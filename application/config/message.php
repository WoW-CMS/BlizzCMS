<?php
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config["message_text"] = "This copy of WoWCMS has not been registered in our licensing service <a href=\"http://wow-cms.com/\" style=\"text-decoration:none;color:white;\"> wow- cms .com </a>. To delete this message, go to Application/config/message.php and type false.";