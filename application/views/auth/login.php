      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small" data-uk-grid>
          ...
          <div class="uk-width-3-5@s">
            <h3 class="uk-h3 uk-text-uppercase uk-text-bold uk-margin-medium-top uk-margin-small-bottom"><?= lang('button_login'); ?></h3>
            ...
            <div class="uk-margin uk-light">
              <label class="uk-form-label"><?= lang('placeholder_password'); ?> <span class="uk-float-right"><a href="<?= base_url('recovery'); ?>" class="uk-button uk-button-text"><?= lang('button_forgot_password'); ?></a></span></label>
              <div class="uk-form-controls">
                <div class="uk-inline uk-width-1-1">
            ...
            <?php endif; ?>
            <button class="uk-button uk-button-default uk-width-1-1" type="submit"><i class="fas fa-sign-in-alt"></i> <?= lang('button_login'); ?></button>
            <?= form_close(); ?>
          </div>
          <div class="uk-width-1-5@s"></div>
        </div>
