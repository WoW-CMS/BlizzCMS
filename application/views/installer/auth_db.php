        ...
        <div class="uk-grid" data-uk-grid>
          ...
          <div class="uk-width-3-5@s">
            ...
            <div class="uk-card uk-card-default uk-card-body">
              <h5 class="uk-h5 uk-heading-line uk-text-uppercase uk-text-bold uk-margin-remove"><span><i class="fas fa-database"></i> <?= lang('auth_database') ?></span></h5>
              <p class="uk-text-meta uk-margin-remove-top uk-margin-small-bottom"><?= lang('auth_database_data') ?></p>
              ...
              <div class="uk-margin-small">
                <div class="uk-grid uk-grid-small" data-uk-grid>
                  ...
                  <div class="uk-inline uk-width-1-2@s">
                    ...
                    <div class="uk-form-controls">
                      <input class="uk-input" type="text" name="prefix" value="<?= set_value('prefix') ?>">
                    </div>
