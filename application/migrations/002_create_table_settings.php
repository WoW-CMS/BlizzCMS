...
class Migration_Create_table_settings extends CI_Migration
{
    public function up()
    {
        ...
        $data = array(
            ...
            array('key' => 'mail_validation', 'value' => 'false'),
            array('key' => 'mail_mailer', 'value' => NULL),
            array('key' => 'mail_hostname', 'value' => NULL),
            array('key' => 'mail_username', 'value' => NULL),
            array('key' => 'mail_password', 'value' => NULL),
            array('key' => 'mail_port', 'value' => NULL),
            array('key' => 'mail_encryption', 'value' => NULL),
            array('key' => 'mail_sender', 'value' => NULL),
