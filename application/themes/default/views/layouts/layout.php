            ...
            <ul class="uk-navbar-nav">
              ...
              <li class="uk-visible@m">
                <?php if ($this->m_data->isLogged()): ?>
                  ...
                  <img class="uk-border-circle" src="<?= base_url('assets/images/profiles/'.$this->m_data->getNameAvatar($this->m_data->getImageProfile($this->session->userdata('wow_sess_id')))); ?>" width="30" height="30" alt="Avatar">
                  <?php else: ?>
                ...
                <div class="uk-offcanvas-bar">
                  ...
                  <div class="uk-panel">
                    ...
                    <div class="uk-padding-small uk-padding-remove-vertical uk-margin-small uk-text-center">
                      <?php if($this->m_general->getUserInfoGeneral($this->session->userdata('wow_sess_id'))->num_rows()): ?>
                      <img class="uk-border-circle" src="<?= base_url('assets/images/profiles/'.$this->m_data->getNameAvatar($this->m_data->getImageProfile($this->session->userdata('wow_sess_id')))); ?>" width="36" height="36" alt="Avatar">
                      <?php else: ?>
