          ...
          <div class="uk-offcanvas-bar">
            ...
            <ul class="uk-nav-default uk-nav-parent-icon" uk-nav>
              ...
              <li class="uk-parent">
                ...
                <ul class="uk-nav-sub">
                  <li><a href="<?= site_url('admin/settings'); ?>"><span class="admin-subnav-icon"><i class="fas fa-sliders-h"></i></span><?= lang('admin_nav_manage_settings'); ?></a></li>
                  <li><a href="<?= site_url('admin/modules'); ?>"><span class="admin-subnav-icon"><i class="fas fa-puzzle-piece"></i></span><?= lang('admin_nav_manage_modules'); ?></a></li>
                </ul>
              </li>
              <li class="uk-parent">
                <a href="javascript:void(0)"><span class="uk-margin-small-right"><i class="fas fa-users"></i></span><?= lang('admin_nav_users'); ?></a>
                <ul class="uk-nav-sub">
                  <li><a href="<?= site_url('admin/accounts'); ?>"><span class="admin-subnav-icon"><i class="fas fa-users-cog"></i></span><?= lang('admin_nav_accounts'); ?></a></li>
                </ul>
              </li>
              <li class="uk-parent">
                <a href="javascript:void(0)"><span class="uk-margin-small-right"><i class="fas fa-mouse-pointer"></i></span><?= lang('admin_nav_website'); ?></a>
                <ul class="uk-nav-sub">
                  <li><a href="<?= site_url('admin/menu'); ?>"><span class="admin-subnav-icon"><i class="fas fa-link"></i></span><?= lang('admin_nav_menu'); ?></a></li>
                  <li><a href="<?= site_url('admin/realms'); ?>"><span class="admin-subnav-icon"><i class="fas fa-server"></i></span><?= lang('admin_nav_realms'); ?></a></li>
                  <li><a href="<?= site_url('admin/slides'); ?>"><span class="admin-subnav-icon"><i class="fas fa-images"></i></span><?= lang('admin_nav_slides'); ?></a></li>
                  <li><a href="<?= site_url('admin/news'); ?>"><span class="admin-subnav-icon"><i class="fas fa-newspaper"></i></span><?= lang('admin_nav_news'); ?></a></li>
                  <li><a href="<?= site_url('admin/changelogs'); ?>"><span class="admin-subnav-icon"><i class="fas fa-scroll"></i></span><?= lang('admin_nav_changelogs'); ?></a></li>
                  <li><a href="<?= site_url('admin/pages'); ?>"><span class="admin-subnav-icon"><i class="fas fa-file-alt"></i></span><?= lang('admin_nav_pages'); ?></a></li>
                  <li><a href="<?= site_url('admin/download'); ?>"><span class="admin-subnav-icon"><i class="fas fa-download"></i></span><?= lang('admin_nav_download'); ?></a></li>
                </ul>
              </li>
              <li class="uk-parent">
                <a href="javascript:void(0)"><span class="uk-margin-small-right"><i class="fas fa-store"></i></span><?= lang('admin_nav_store'); ?></a>
                <ul class="uk-nav-sub">
                  <li><a href="<?= site_url('admin/store'); ?>"><span class="admin-subnav-icon"><i class="fas fa-shopping-cart"></i></span><?= lang('admin_nav_manage_store'); ?></a></li>
                  <li><a href="<?= site_url('admin/donate'); ?>"><span class="admin-subnav-icon"><i class="fas fa-donate"></i></span><?= lang('admin_nav_donate_methods'); ?></a></li>
                  <li><a href="<?= site_url('admin/topsites'); ?>"><span class="admin-subnav-icon"><i class="fas fa-star"></i></span><?= lang('admin_nav_topsites'); ?></a></li>
                </ul>
              </li>
              <li class="uk-parent">
                <a href="javascript:void(0)"><span class="uk-margin-small-right"><i class="fas fa-comments"></i></span><?= lang('admin_nav_forum'); ?></a>
                <ul class="uk-nav-sub">
                  <li><a href="<?= site_url('admin/forum'); ?>"><span class="admin-subnav-icon"><i class="fas fa-bookmark"></i></span><?= lang('admin_nav_manage_forum'); ?></a></li>
                </ul>
              </li>
              <li><a href="<?= site_url('admin/tickets'); ?>"><span class="admin-subnav-icon"><i class="fas fa-scroll"></i></span><?= lang('admin_nav_Tickets'); ?></a></li>
            </ul>
          </div>
        </div>
      </div>
              ...
              <li>
                ...
                <div class="uk-navbar-dropdown">
                  <ul class="uk-nav uk-navbar-dropdown-nav">
                    ...
                    <li><a href="<?= site_url('admin/donate'); ?>"><span class="admin-subnav-icon"><i class="fas fa-donate"></i></span><?= lang('admin_nav_donate_methods'); ?></a></li>
                    <li><a href="<?= site_url('admin/topsites'); ?>"><span class="admin-subnav-icon"><i class="fas fa-star"></i></span><?= lang('admin_nav_topsites'); ?></a></li>
                    <li><a href="<?= site_url('admin/donate/logs'); ?>"><span class="admin-subnav-icon"><i class="fas fa-receipt"></i></span><?= lang('admin_nav_donate_logs'); ?></a></li>
                    <li><a href="<?= site_url('admin/vote/logs'); ?>"><span class="admin-subnav-icon"><i class="fas fa-receipt"></i></span><?= lang('admin_nav_vote_logs'); ?></a></li>
                  </ul>
                </div>
              </li>
              <li>
