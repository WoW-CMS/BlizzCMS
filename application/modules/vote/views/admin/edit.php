      ...
      <div class="uk-container">
        ...
        <div class="uk-card uk-card-default">
          <div class="uk-card-header">
            <h5 class="uk-h5 uk-text-uppercase uk-text-bold"><i class="fas fa-pen"></i> <?= lang('edit_topsite') ?></h5>
          </div>
          <div class="uk-card-body">
              ...
              <div class="uk-grid uk-grid-small" data-uk-grid>
                <div class="uk-inline uk-width-1-2@s">
                  ...
                  <div class="uk-form-controls">
                    <input class="uk-input" type="text" name="name" value="<?= $topsite->name ?>" placeholder="<?= lang('name') ?>">
                  </div>
                ...
                <div class="uk-inline uk-width-1-2@s">
                  ...
                  <div class="uk-form-controls">
                    <input class="uk-input" type="url" name="url" value="<?= $topsite->url ?>" placeholder="<?= lang('url') ?>">
                  </div>
            ...
            <div class="uk-margin-small">
              <div class="uk-grid uk-grid-small" data-uk-grid>
                <div class="uk-inline uk-width-1-2@s">
                  ...
                  <div class="uk-form-controls">
                    <input class="uk-input" type="number" name="time" value="<?= $topsite->time ?>" placeholder="Hours">
                  </div>
                ...
                <div class="uk-inline uk-width-1-2@s">
                  ...
                  <div class="uk-form-controls">
                    <input class="uk-input" type="number" name="points" value="<?= $topsite->points ?>" min="1" placeholder="<?= lang('points') ?>">
                  </div>
            ...
            <div class="uk-margin-small">
              ...
              <div class="uk-form-controls">
                <input class="uk-input" type="url" name="image" value="<?= $topsite->image ?>" placeholder="http://example.com/image.jpg">
              </div>
