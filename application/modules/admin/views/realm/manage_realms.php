      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
          <div class="uk-width-expand uk-heading-line">
            <h3 class="uk-h3"><i class="fas fa-server"></i> <?= lang('admin_nav_realms'); ?></h3>
          </div>
          <div class="uk-width-auto">
            <a href="<?= site_url('admin/realms/create'); ?>" class="uk-icon-button"><i class="fas fa-cog"></i></a>
          </div>
        </div>
            ...
            <table class="uk-table uk-table-middle uk-table-divider uk-table-small">
              <thead>
                <tr>
                  ...
                  <th class="uk-width-medium"><?= lang('placeholder_db_name'); ?></th>
                ...
                <tr>
                  ...
                  <td>
                    <div class="uk-flex uk-flex-left uk-flex-center@m uk-margin-small">
                      <a href="<?= site_url('admin/realms/edit/'.$realmsID->id); ?>" class="uk-button uk-button-primary uk-margin-small-right"><i class="fas fa-edit"></i></a>
    ...
    <script>
      function DeleteRealm(e, value) {
        ...
        $.ajax({
          url:"<?= site_url('admin/realms/delete'); ?>",
          method:"POST",
          data:{value},
          dataType:"text",
          beforeSend: function(){
            ...
            if (response) {
              $.amaran({
                'theme': 'awesome ok',
                  ...
                  message: '<?= lang('notification_realm_deleted'); ?>',
                  info: '',
