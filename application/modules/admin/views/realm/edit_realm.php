      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
          <div class="uk-width-expand uk-heading-line">
            <h3 class="uk-h3"><i class="fas fa-server"></i> <?= lang('placeholder_edit_realm'); ?></h3>
          </div>
        ...
        <div class="uk-card uk-card-default">
          <div class="uk-card-body">
            ...
            <div class="uk-margin-small">
              <button class="uk-button uk-button-primary uk-width-1-1" type="submit" name="button_uprealm"><i class="fas fa-sync-alt"></i> <?= lang('button_save'); ?></button>
            </div>
            <?= form_close(); ?>
          </div>
        </div>
            ...
            if (response) {
              $.amaran({
                'theme': 'awesome ok',
                  ...
                  message: '<?= lang('notification_realm_edited'); ?>',
                  info: '',
