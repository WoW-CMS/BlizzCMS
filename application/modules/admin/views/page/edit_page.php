      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
          <div class="uk-width-expand uk-heading-line">
            <h3 class="uk-h3"><i class="fas fa-edit"></i> <?= lang('placeholder_edit_page'); ?></h3>
          </div>
        ...
        <div class="uk-card uk-card-default">
          <div class="uk-card-body">
            ...
            <div class="uk-margin-small">
              ...
              <div class="uk-form-controls">
                <div class="uk-inline uk-width-1-1">
                  ...
                  <input class="uk-input" type="text" id="page_title" value="<?= $this->admin_model->getPagesSpecifyName($idlink); ?>" placeholder="<?= lang('placeholder_title'); ?>" required>
                </div>
              </div>
            </div>
            <div class="uk-margin-small">
              ...
              <div class="uk-form-controls">
                <div class="uk-inline uk-width-1-1">
                  ...
                  <input class="uk-input" type="text" id="page_uri" value="<?= $this->admin_model->getPagesSpecifyURI($idlink); ?>" placeholder="<?= lang('placeholder_uri'); ?>" required>
                </div>
              </div>
            </div>
            <div class="uk-margin-small">
            ...
            <div class="uk-margin-small">
              <button class="uk-button uk-button-primary uk-width-1-1" type="submit" id="button_uppage"><i class="fas fa-sync-alt"></i> <?= lang('button_save'); ?></button>
            </div>
            <?= form_close(); ?>
          </div>
        </div>
    ...
    <script>
      function UpdatePageForm(e) {
        ...
        $.ajax({
          url:"<?= base_url('admin/pages/update'); ?>",
          method:"POST",
            ...
            if (response) {
              $.amaran({
                'theme': 'awesome ok',
                  ...
                  message: '<?= lang('notification_page_edited'); ?>',
                  info: '',
