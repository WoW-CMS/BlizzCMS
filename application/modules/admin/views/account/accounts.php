      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
          <div class="uk-width-expand uk-heading-line">
            <h3 class="uk-h3"><i class="fas fa-users-cog"></i> <?= lang('admin_nav_accounts'); ?></h3>
          </div>
            ...
            <table class="uk-table uk-table-hover uk-table-middle uk-table-divider uk-table-small">
              <thead>
                <tr>
                  ...
                  <th class="uk-width-small uk-text-center"><?= lang('placeholder_email'); ?></th>
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <img class="uk-preserve-width uk-border-rounded" src="<?= $template['uploads'].'avatars/'.$this->website->user_avatar($account->id); ?>" alt="Avatar" width="36">
                    <span class="uk-text-middle"><?= $account->username ?></span>
                  </td>
                  <td class="uk-text-center"><?= $account->email ?></td>
                  <td class="uk-text-center"><?= date('Y-m-d', $account->joined_at); ?></td>
                  <td>
