  ...
  <div class="uk-container">
    <div class="uk-flex uk-flex-middle uk-margin" uk-grid>
      <div class="uk-width-expand">
        ...
        <h1 class="uk-h3 uk-text-bold uk-margin-remove"><?= lang('edit_menu_item') ?></h1>
      </div>
          ...
          <div class="uk-grid-small uk-margin-small" uk-grid>
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="name" value="<?= $item->name ?>" placeholder="<?= lang('name') ?>" autocomplete="off">
              </div>
            ...
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="url" value="<?= $item->url ?>" placeholder="<?= lang('url') ?>" autocomplete="off">
              </div>
            ...
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="icon" value="<?= $item->icon ?>" placeholder="<?= lang('icon') ?>" autocomplete="off">
              </div>
            ...
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <select class="uk-select tail-single" id="select_target" name="target" autocomplete="off" data-placeholder="<?= lang('select_target') ?>">
                  <option value="<?= TARGET_SELF ?>" <?= set_select('target', TARGET_SELF, TARGET_SELF === $item->target) ?>><?= lang('same_tab') ?></option>
                  <option value="<?= TARGET_BLANK ?>" <?= set_select('target', TARGET_BLANK, TARGET_BLANK === $item->target) ?>><?= lang('new_tab') ?></option>
                </select>
              </div>
            ...
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <select class="uk-select tail-single" id="select_type" name="type" autocomplete="off" data-placeholder="<?= lang('select_type') ?>">
                  <option value="<?= ITEM_LINK ?>" <?= set_select('type', ITEM_LINK, $item->type === ITEM_LINK) ?>><?= lang('link') ?></option>
                  <option value="<?= ITEM_DROPDOWN ?>" <?= set_select('type', ITEM_DROPDOWN, $item->type === ITEM_DROPDOWN) ?>><?= lang('dropdown') ?></option>
                </select>
              </div>
            ...
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <select class="uk-select tail-single" id="select_parent" name="parent" autocomplete="off" data-placeholder="<?= lang('select_parent') ?>">
                  <option value="0" <?= set_select('parent', '0', '0' === $item->parent) ?>><?= lang('no_parent') ?></option>
                  <?php foreach ($parents as $parent): ?>
                  <option value="<?= $parent->id ?>" <?= set_select('parent', $parent->id, $parent->id === $item->parent) ?>><?= $parent->name ?></option>
                  <?php endforeach ?>
                </select>
              </div>
