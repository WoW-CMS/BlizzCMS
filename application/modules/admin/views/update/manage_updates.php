      ...
      <div class="uk-container">
        ...
        <div class="uk-grid uk-grid-small" data-uk-grid>
          ...
          <div class="uk-width-3-4@s">
			...
			<h5 class="uk-h5 uk-text-bold uk-text-uppercase uk-margin-remove"><i class="fa-solid fa-circle-check"></i> <?= lang('notification_title_success') ?></h5>
			...
			<a class="uk-alert-close" uk-close></a>
			<h5 class="uk-h5 uk-text-bold uk-text-uppercase uk-margin-remove"><i class="fa-solid fa-circle-info"></i> <?= lang('notification_title_info') ?></h5>
			...
			<a class="uk-alert-close" uk-close></a>
			<h5 class="uk-h5 uk-text-bold uk-text-uppercase uk-margin-remove"><i class="fa-solid fa-circle-exclamation"></i> <?= lang('notification_title_warning') ?></h5>
			...
			<div class="uk-alert-danger uk-margin-small" uk-alert>
				<a class="uk-alert-close" uk-close></a>
			<h5 class="uk-h5 uk-text-bold uk-text-uppercase uk-margin-remove"><i class="fa-solid fa-circle-xmark"></i> <?= lang('notification_title_error') ?></h5>
                  ...
                  <div class="uk-card-body">
                    <div class="uk-grid uk-grid-small" data-uk-grid>
                      ...
                      <div class="uk-width-expand uk-text-center uk-text-right@m">
                        <a href="<?= site_url('admin/cms/update') ?>" class="uk-button uk-button-primary uk-button-large"><i class="fas fa-sync fa-spin"></i> <?= lang('button_update_version'); ?></a>
                      </div>
                    </div>
