  ...
  <div class="uk-container">
    <div class="uk-flex uk-flex-middle uk-margin" uk-grid>
      <div class="uk-width-expand">
        ...
        <h1 class="uk-h3 uk-text-bold uk-margin-remove"><?= lang('edit_slide') ?></h1>
      </div>
              ...
              <div class="uk-grid-small uk-margin-small" uk-grid>
                <div class="uk-width-1-1">
                  ...
                  <div class="uk-form-controls">
                    <input class="uk-input" type="text" name="title" value="<?= $slide->title ?>" placeholder="<?= lang('title') ?>" autocomplete="off">
                  </div>
                ...
                <div class="uk-width-1-1">
                  ...
                  <div class="uk-form-controls">
                    <textarea class="uk-textarea" name="description" rows="4" autocomplete="off"><?= $slide->description ?></textarea>
                  </div>
            ...
            <div class="uk-card-body">
              <div id="mfp_container" class="uk-placeholder uk-padding-small uk-margin-small-bottom">
                <div class="uk-cover-container uk-height-small">
                  ...
                  <img src="<?= $template['uploads'].$slide->path ?>" alt="<?= lang('preview') ?>" uk-cover>
                  <?php elseif ($slide->type === SLIDE_VIDEO): ?>
                  <video src="<?= $template['uploads'].$slide->path ?>" controls uk-cover></video>
                  <?php endif ?>
                </div>
              </div>
