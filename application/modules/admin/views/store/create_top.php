              ...
              <div class="uk-margin-small">
                ...
                <div class="uk-form-controls">
                  <select class="uk-select" id="store_top_item">
                    ...
                    <option value="<?= $item->id ?>"><?= $item->name ?> (<?= $this->admin_model->getStoreCategoryName($item->category); ?> - <?= $this->realm->getRealmName($this->admin_model->getStoreCategoryRealm($item->category)); ?>)</option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
