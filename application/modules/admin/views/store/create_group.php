              ...
              <div class="uk-margin-small">
                ...
                <div class="uk-form-controls">
                  <div class="uk-inline uk-width-1-1">
                    ...
                    <input class="uk-input" name="group_name" type="text" placeholder="<?= $this->lang->line('placeholder_group_title'); ?>" required>
                  </div>
                </div>
              </div>
              <div class="uk-margin-small">
                <button class="uk-button uk-button-primary uk-width-1-1" name="button_createGroup" type="submit"><i class="fas fa-check-circle"></i> <?= $this->lang->line('button_create'); ?></button>
              </div>
            </form>
          </div>
        </div>
