          ...
          <div class="uk-width-1-4@s">
            <div class="uk-card uk-card-secondary">
              <ul class="uk-nav uk-nav-default">
                ...
                <li><a href="<?= base_url('admin/store/items'); ?>"><i class="fas fa-boxes"></i> <?= lang('section_store_items'); ?></a></li>
                <li class="uk-active"><a href="<?= base_url('admin/store/top'); ?>"><i class="fas fa-parachute-box"></i> <?= lang('section_store_top'); ?></a></li>
              </ul>
            </div>
          </div>
    ...
    <script>
      function DeleteTop(e, value) {
        ...
        $.ajax({
          url:"<?= base_url('admin/store/top/delete'); ?>",
          method:"POST",
          data:{value},
          dataType:"text",
          beforeSend: function(){
