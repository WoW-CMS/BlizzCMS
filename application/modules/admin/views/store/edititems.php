            ...
            <div class="uk-card-header">
              <div class="uk-grid uk-grid-small">
                <div class="uk-width-auto">
                  <h4 class="uk-h4"><span class="uk-margin-small-right"><i class="fas fa-edit"></i></span><?= $this->lang->line('card_title_edit_item'); ?></h4>
                </div>
                ...
                <div class="uk-margin-small">
                  ...
                  <div class="uk-form-controls">
                    <div class="uk-inline uk-width-1-1">
                      ...
                      <input class="uk-input" name="itemname" type="text" value="<?= $this->admin_model->getItemSpecifyName($idlink); ?>" placeholder="<?= $this->lang->line('placeholder_store_item_name'); ?>" required>
                    </div>
                  </div>
                </div>
                <div class="uk-margin-small">
