                  ...
                  <div class="uk-inline uk-width-1-2@s">
                    ...
                    <div class="uk-form-controls">
                      <select class="uk-select" id="store_category_realm">
                        ...
                        <option value="<?= $MultiRealm->realmID ?>" <?php if($this->admin_model->getStoreCategoryRealm($idlink) == $MultiRealm->realmID) echo 'selected'; ?>><?= $this->realm->getRealmName($MultiRealm->realmID); ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
