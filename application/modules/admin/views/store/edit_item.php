      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
          <div class="uk-width-expand uk-heading-line">
            <h3 class="uk-h3"><i class="fas fa-edit"></i> <?= lang('placeholder_edit_item'); ?></h3>
          </div>
        ...
        <div class="uk-card uk-card-default">
          <div class="uk-card-body">
            <?= form_open('', 'id="updateitemForm" onsubmit="UpdateItemForm(event)"'); ?>
              <div class="uk-margin-small">
                ...
                <div class="uk-form-controls">
                  <div class="uk-inline uk-width-1-1">
                    ...
                    <input class="uk-input" type="text" id="item_name" value="<?= $this->admin_model->getItemSpecifyName($idlink); ?>" placeholder="<?= lang('placeholder_name'); ?>" required>
                  </div>
                </div>
              </div>
              <div class="uk-margin-small">
                  ...
                  <div class="uk-inline uk-width-1-2@s">
                    ...
                    <div class="uk-form-controls">
                      <select class="uk-select" id="item_type">
                        ...
                        <option value="1" <?php if($this->admin_model->getItemSpecifyType($idlink) == 1) echo 'selected'; ?>><?= lang('placeholder_item'); ?></option>
                        <option value="2" <?php if($this->admin_model->getItemSpecifyType($idlink) == 2) echo 'selected'; ?>><?= lang('table_header_money'); ?></option>
                        <option value="3" <?php if($this->admin_model->getItemSpecifyType($idlink) == 3) echo 'selected'; ?>><?= lang('table_header_level'); ?></option>
                        <option value="4" <?php if($this->admin_model->getItemSpecifyType($idlink) == 4) echo 'selected'; ?>><?= lang('option_rename'); ?></option>
                        <option value="5" <?php if($this->admin_model->getItemSpecifyType($idlink) == 5) echo 'selected'; ?>><?= lang('option_customize'); ?></option>
                        <option value="6" <?php if($this->admin_model->getItemSpecifyType($idlink) == 6) echo 'selected'; ?>><?= lang('option_change_faction'); ?></option>
                        <option value="7" <?php if($this->admin_model->getItemSpecifyType($idlink) == 7) echo 'selected'; ?>><?= lang('option_change_race'); ?></option>
                      </select>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="uk-inline uk-width-1-2@s">
                    ...
                    <div class="uk-form-controls">
                      <select class="uk-select" id="item_price_type">
                        <option value="0"><?= lang('table_header_price'); ?> <?= lang('notification_select_type'); ?></option>
                        <option value="1" <?php if($this->admin_model->getItemSpecifyPriceType($idlink) == 1) echo 'selected'; ?>><?= lang('option_dp'); ?></option>
                        <option value="2" <?php if($this->admin_model->getItemSpecifyPriceType($idlink) == 2) echo 'selected'; ?>><?= lang('option_vp'); ?></option>
                        <option value="3" <?php if($this->admin_model->getItemSpecifyPriceType($idlink) == 3) echo 'selected'; ?>><?= lang('option_dp_vp'); ?></option>
                      </select>
                    </div>
                  </div>
                </div>
              ...
              <div class="uk-margin-small">
                <button class="uk-button uk-button-primary uk-width-1-1" id="button_upitem" type="submit"><i class="fas fa-sync-alt"></i> <?= lang('button_save'); ?></button>
              </div>
            <?= form_close(); ?>
          </div>
        </div>
    ...
    <script>
      function UpdateItemForm(e) {
        ...
        $.ajax({
          url:"<?= base_url('admin/store/item/update'); ?>",
          method:"POST",
            ...
            if (response) {
              $.amaran({
                'theme': 'awesome ok',
                  ...
                  message: '<?= lang('notification_item_edited'); ?>',
                  info: '',
