          ...
          <div class="uk-width-1-4@s">
            <div class="uk-card uk-card-secondary">
              <ul class="uk-nav uk-nav-default">
                <li><a href="<?= base_url('admin/store'); ?>"><i class="fas fa-tags"></i> <?= lang('section_store_categories'); ?></a></li>
                <li class="uk-active"><a href="<?= base_url('admin/store/items'); ?>"><i class="fas fa-boxes"></i> <?= lang('section_store_items'); ?></a></li>
                <li><a href="<?= base_url('admin/store/top'); ?>"><i class="fas fa-parachute-box"></i> <?= lang('section_store_top'); ?></a></li>
              </ul>
            </div>
          </div>
                ...
                <table class="uk-table uk-table-middle uk-table-divider uk-table-small">
                  <thead>
                    <tr>
                      ...
                      <th class="uk-width-small uk-text-center"><?= lang('table_header_price'); ?> <?= lang('placeholder_type'); ?></th>
                      <th class="uk-width-small uk-text-center"><?= lang('option_dp'); ?> <?= lang('table_header_price'); ?></th>
                      <th class="uk-width-small uk-text-center"><?= lang('option_dp'); ?> <?= lang('table_header_price'); ?></th>
    ...
    <script>
      function DeleteItem(e, value) {
        ...
        $.ajax({
          url:"<?= base_url('admin/store/items/delete'); ?>",
          method:"POST",
          data:{value},
          dataType:"text",
          beforeSend: function(){
            ...
            if (response) {
              $.amaran({
                'theme': 'awesome ok',
                  ...
                  message: '<?= lang('notification_item_deleted'); ?>',
                  info: '',
