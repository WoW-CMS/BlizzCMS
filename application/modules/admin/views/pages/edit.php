      ...
      <div class="uk-container">
        ...
        <div class="uk-card uk-card-default">
          <div class="uk-card-header">
            <h5 class="uk-h5 uk-text-uppercase uk-text-bold"><i class="fas fa-pen"></i> <?= lang('edit_page') ?></h5>
          </div>
          <div class="uk-card-body">
            ...
            <div class="uk-margin-small">
              ...
              <div class="uk-form-controls">
                <textarea class="uk-textarea textarea-content" name="description" rows="12"><?= $page->description ?></textarea>
              </div>
