  ...
  <div class="uk-container">
    <div class="uk-flex uk-flex-middle uk-margin" uk-grid>
      <div class="uk-width-expand">
        ...
        <h1 class="uk-h3 uk-text-bold uk-margin-remove"><?= lang('add_realm') ?></h1>
      </div>
          ...
          <div class="uk-grid-small" uk-grid>
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="realm_name" value="<?= set_value('realm_name') ?>" placeholder="<?= lang('name') ?>" autocomplete="off">
              </div>
            ...
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="realm_capacity" value="<?= set_value('realm_capacity') ?>" placeholder="<?= lang('maximum_capacity') ?>" autocomplete="off">
              </div>
        ...
        <div class="uk-card-body">
          <div class="uk-grid-small uk-margin-small-bottom" uk-grid>
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="char_hostname" value="<?= set_value('char_hostname') ?>" placeholder="<?= lang('hostname') ?>" autocomplete="off">
              </div>
            ...
            <div class="uk-width-1-4@s">
              ...
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="char_port" value="<?= set_value('char_port') ?>" placeholder="<?= lang('port') ?>" autocomplete="off">
              </div>
            ...
            <div class="uk-width-1-4@s">
              ...
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="char_database" value="<?= set_value('char_database') ?>" placeholder="<?= lang('database') ?>" autocomplete="off">
              </div>
          ...
          <div class="uk-grid-small uk-margin-small-top" uk-grid>
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="char_username" value="<?= set_value('char_username') ?>" placeholder="<?= lang('username') ?>" autocomplete="off">
              </div>
        ...
        <div class="uk-card-body">
          <div class="uk-grid-small uk-margin-small-bottom" uk-grid>
            <div class="uk-width-1-2@s">
              <label class="uk-form-label"><?= lang('hostname') ?></label>
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="console_hostname" value="<?= set_value('console_hostname') ?>" placeholder="<?= lang('hostname') ?>" autocomplete="off">
              </div>
            ...
            <div class="uk-width-1-2@s">
              <label class="uk-form-label"><?= lang('port') ?></label>
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="console_port" value="<?= set_value('console_port') ?>" placeholder="<?= lang('port') ?>" autocomplete="off">
              </div>
          ...
          <div class="uk-grid-small uk-margin-small-top" uk-grid>
            <div class="uk-width-1-2@s">
              <label class="uk-form-label"><?= lang('username') ?></label>
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="console_username" value="<?= set_value('console_username') ?>" placeholder="<?= lang('username') ?>" autocomplete="off">
              </div>
        ...
        <div class="uk-card-body">
          <div class="uk-grid-small" uk-grid>
            <div class="uk-width-1-2@s">
              <label class="uk-form-label"><?= lang('hostname') ?></label>
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="realm_hostname" value="<?= set_value('realm_hostname') ?>" placeholder="<?= lang('hostname') ?>" autocomplete="off">
              </div>
            ...
            <div class="uk-width-1-2@s">
              <label class="uk-form-label"><?= lang('port') ?></label>
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="realm_port" value="<?= set_value('realm_port') ?>" placeholder="<?= lang('port') ?>" autocomplete="off">
              </div>
