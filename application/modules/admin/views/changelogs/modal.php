      <div id="newChangelog" uk-modal="bg-close: false">
        <div class="uk-modal-dialog">
          ...
          <div class="uk-modal-header">
            <h3 class="uk-modal-title uk-text-uppercase"><i class="fas fa-history"></i> <?= $this->lang->line('placeholder_create_changelog'); ?></h3>
          </div>
          <form action="" method="post" enctype="multipart/form-data" accept-charset="utf-8" autocomplete="off">
            <div class="uk-modal-body">
              <div class="uk-margin-small">
                <label class="uk-form-label uk-text-uppercase"><?= $this->lang->line('placeholder_changelog_title'); ?></label>
                <div class="uk-form-controls">
                  <div class="uk-inline uk-width-1-1">
                    <span class="uk-form-icon uk-form-icon-flip" uk-icon="icon: pencil"></span>
                    <input class="uk-input" name="chang_title" required type="text" placeholder="<?= $this->lang->line('placeholder_changelog_title'); ?>">
                  </div>
                </div>
              </div>
              <div class="uk-margin-small">
