            ...
            <div class="uk-card-header">
              <div class="uk-grid uk-grid-small">
                <div class="uk-width-auto">
                  <h4 class="uk-h4"><span class="uk-margin-small-right"><i class="fas fa-edit"></i></span><?= $this->lang->line('card_title_edit_changelogs'); ?> - <?= $this->admin_model->getChangelogSpecifyName($idlink); ?></h4>
                </div>
