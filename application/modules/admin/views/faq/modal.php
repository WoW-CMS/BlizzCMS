      ...
      <div id="newFaq" uk-modal="bg-close: false">
        <div class="uk-modal-dialog">
          ...
          <div class="uk-modal-header">
            <h3 class="uk-modal-title uk-text-uppercase"><i class="fas fa-question-circle"></i> <?= $this->lang->line('placeholder_create_faq'); ?></h3>
          </div>
              ...
              <div class="uk-margin-small">
                ...
                <div class="uk-form-controls">
                  <div class="uk-inline uk-width-1-1">
                    ...
                    <input class="uk-input" name="faq_title" required type="text" placeholder="<?= $this->lang->line('placeholder_faq_title'); ?>">
                  </div>
                </div>
              </div>
              <div class="uk-margin-small">
