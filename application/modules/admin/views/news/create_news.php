      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
          <div class="uk-width-expand uk-heading-line">
            <h3 class="uk-h3"><i class="fas fa-plus-circle"></i> <?= lang('placeholder_create_news'); ?></h3>
          </div>
        ...
        <div class="uk-card uk-card-default">
          <div class="uk-card-body">
            <form action="" method="post" enctype="multipart/form-data" accept-charset="utf-8" autocomplete="off">
              <div class="uk-margin-small">
                ...
                <div class="uk-form-controls">
                  <div class="uk-inline uk-width-1-1">
                    ...
                    <input class="uk-input" type="text" name="news_title" placeholder="<?= lang('placeholder_title'); ?>" required>
                  </div>
                </div>
              </div>
              <div class="uk-margin-small">
              ...
              <div class="uk-margin-small">
                <button class="uk-button uk-button-primary uk-width-1-1" type="submit" name="button_news"><i class="fas fa-check-circle"></i> <?= lang('button_create'); ?></button>
              </div>
            </form>
          </div>
        </div>
