  ...
  <div class="uk-container">
    <div class="uk-flex uk-flex-middle uk-margin" uk-grid>
      <div class="uk-width-expand">
        ...
        <h1 class="uk-h3 uk-text-bold uk-margin-remove"><?= lang('edit_news') ?></h1>
      </div>
              ...
              <div class="uk-grid-small uk-margin-small" uk-grid>
                <div class="uk-width-1-1">
                  ...
                  <div class="uk-form-controls">
                    <input class="uk-input" type="text" name="title" value="<?= $article->title ?>" placeholder="<?= lang('title') ?>" autocomplete="off">
                  </div>
                ...
                <div class="uk-width-1-1">
                  ...
                  <div class="uk-form-controls">
                    <textarea class="uk-textarea tmce-content" name="content" rows="12" autocomplete="off"><?= $article->content ?></textarea>
                  </div>
            ...
            <div class="uk-card-body">
              <div id="mfp_container" class="uk-placeholder uk-padding-small uk-margin-small-bottom">
                <div class="uk-cover-container uk-height-small">
                  <img src="<?= $template['uploads'].$article->image ?>" alt="<?= lang('preview') ?>" uk-cover>
                </div>
              </div>
                    ...
                    <div class="uk-grid-small uk-flex uk-flex-middle" uk-grid>
                      <div class="uk-width-auto">
                        <label class="uk-switch uk-display-block">
                          <input type="checkbox" name="discuss" value="1" <?= set_checkbox('discuss', '1', '1' === $article->discuss) ?>>
              ...
              <div class="uk-accordion-content">
                <div class="uk-grid-small uk-margin-small" uk-grid>
                  <div class="uk-width-1-1">
                    ...
                    <div class="uk-form-controls">
                      <textarea class="uk-textarea" name="meta_description" rows="4" autocomplete="off"><?= $article->meta_description ?></textarea>
                    </div>
                  ...
                  <div class="uk-width-1-1">
                    ...
                    <div class="uk-form-controls">
                      <input class="uk-input" type="text" name="meta_robots" value="<?= $article->meta_robots ?>" autocomplete="off">
                    </div>
