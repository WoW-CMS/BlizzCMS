          ...
          <div>
            <div class="uk-card uk-card-default">
              ...
              <div class="uk-card-body">
                ...
                <h6 class="uk-h6 uk-text-uppercase uk-margin-remove uk-text-center"><i class="fas fa-user-friends"></i> <span class="blizzcms-count uk-text-bold uk-text-warning" data-from="0" data-to="<?= $this->wowrealm->getAllCharactersOnline($multiRealm); ?>" data-speed="2000" data-refresh-interval="50"></span> <?= lang('info_players_playing'); ?></h6>
              </div>
            </div>
          </div>
          <?php endforeach; ?>
