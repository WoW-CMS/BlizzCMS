              ...
              <div class="uk-grid uk-grid-small uk-grid-divider uk-grid-match uk-child-width-1-1" data-uk-grid>
                <div>
                  <div class="uk-text-center">
                    ...
                    <h1 class="uk-h1 uk-margin-small"><span class="number-counter uk-text-primary" data-from="0" data-to="0" data-speed="2000" data-refresh-interval="50"></span><span class="uk-margin-small-left"><i class="fas fa-user-friends"></i></span></h1>
                ...
                <div>
                  <div class="uk-text-center">
                    ...
                    <h1 class="uk-h1 uk-margin-small"><span class="number-counter uk-text-primary" data-from="0" data-to="0" data-speed="2000" data-refresh-interval="50"></span><span class="uk-margin-small-left"><i class="fas fa-user-slash"></i></span></h1>
