      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
          <div class="uk-width-expand uk-heading-line">
            <h3 class="uk-h3"><i class="fas fa-plus-circle"></i> <?= $this->lang->line('placeholder_create_forums'); ?></h3>
          </div>
              ...
              <div class="uk-margin-small">
                ...
                <div class="uk-form-controls">
                  <div class="uk-inline uk-width-1-1">
                    ...
                    <input class="uk-input" type="text" id="forum_name" placeholder="<?= $this->lang->line('placeholder_forum_title'); ?>" required>
                  </div>
                </div>
              </div>
              <div class="uk-margin-small">
                ...
                <div class="uk-form-controls">
                  <div class="uk-inline uk-width-1-1">
                    <input class="uk-input" type="text" id="forum_description" placeholder="<?= $this->lang->line('placeholder_forum_description'); ?>" required>
                  </div>
                </div>
              </div>
              <div class="uk-margin-small">
                ...
                <div class="uk-form-controls">
                  <div class="uk-inline uk-width-1-1">
                    <input class="uk-input" type="text" id="forum_icon" placeholder="<?= $this->lang->line('placeholder_forum_icon'); ?>" required>
                  </div>
                </div>
              </div>
              <div class="uk-margin-small">
