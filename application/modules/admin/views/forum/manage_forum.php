          ...
          <div class="uk-width-1-4@s">
            <div class="uk-card uk-card-secondary">
              <ul class="uk-nav uk-nav-default">
                <li class="uk-active"><a href="<?= base_url('admin/forum'); ?>"><i class="fas fa-tags"></i> <?= lang('section_forum_categories'); ?></a></li>
                <li><a href="<?= base_url('admin/forum/elements'); ?>"><i class="fas fa-comment-dots"></i> <?= lang('section_forum_elements'); ?></a></li>
              </ul>
            </div>
          </div>
