      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
          <div class="uk-width-expand uk-heading-line">
            <h3 class="uk-h3"><i class="fas fa-edit"></i> <?= lang('placeholder_edit_forum'); ?></h3>
          </div>
        ...
        <div class="uk-card uk-card-default">
          <div class="uk-card-body">
            <?= form_open('', 'id="updateforumForm" onsubmit="UpdateForumForm(event)"'); ?>
              <div class="uk-margin-small">
                ...
                <div class="uk-form-controls">
                  <div class="uk-inline uk-width-1-1">
                    ...
                    <input class="uk-input" type="text" id="forum_name" value="<?= $this->admin_model->getSpecifyForumName($idlink); ?>" placeholder="<?= lang('placeholder_title'); ?>" required>
                  </div>
                </div>
              </div>
              <div class="uk-margin-small">
                ...
                <div class="uk-form-controls">
                  <div class="uk-inline uk-width-1-1">
                    <input class="uk-input" type="text" id="forum_description" value="<?= $this->admin_model->getSpecifyForumDesc($idlink); ?>" placeholder="<?= lang('placeholder_description'); ?>" required>
                  </div>
                </div>
              </div>
              <div class="uk-margin-small">
                ...
                <div class="uk-form-controls">
                  <div class="uk-inline uk-width-1-1">
                    <input class="uk-input" type="text" id="forum_icon" value="<?= $this->admin_model->getSpecifyForumIcon($idlink); ?>" placeholder="<?= lang('placeholder_icon_name'); ?>" required>
                  </div>
                </div>
              </div>
              <div class="uk-margin-small">
                ...
                <div class="uk-form-controls">
                  <select class="uk-select" id="forum_type">
                    ...
                    <option value="1" <?php if($this->admin_model->getSpecifyForumType($idlink) == '1') echo 'selected'; ?>><?= lang('option_everyone'); ?></option>
                    <option value="2" <?php if($this->admin_model->getSpecifyForumType($idlink) == '2') echo 'selected'; ?>><?= lang('option_staff'); ?></option>
                    <option value="3" <?php if($this->admin_model->getSpecifyForumType($idlink) == '3') echo 'selected'; ?>><?= lang('option_all'); ?></option>
                  </select>
                </div>
              </div>
              <div class="uk-margin-small">
              ...
              <div class="uk-margin-small">
                <button class="uk-button uk-button-primary uk-width-1-1" type="submit" name="button_upforum"><i class="fas fa-sync-alt"></i> <?= lang('button_save'); ?></button>
              </div>
            <?= form_close(); ?>
          </div>
        </div>
    ...
    <script>
      function UpdateForumForm(e) {
        ...
        $.ajax({
          url:"<?= site_url('admin/forum/update'); ?>",
          method:"POST",
          ...
          success:function(response){
            ...
            if (response) {
              $.amaran({
                'theme': 'awesome ok',
                  ...
                  message: '<?= lang('notification_forum_edited'); ?>',
                  info: '',
            ...
            window.location.replace("<?= site_url('admin/forum/edit/'.$idlink); ?>");
          }
        });
      }
    </script>
