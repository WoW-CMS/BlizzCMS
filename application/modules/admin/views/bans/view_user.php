<section class="uk-section uk-section-xsmall" uk-height-viewport="expand: true">
  <div class="uk-container">
    ...
    <div class="uk-grid-match uk-child-width-1-2@s uk-child-width-1-3@m uk-margin" uk-grid>
      <div>
        <div class="uk-card uk-card-default uk-card-body">
          <div class="uk-grid-small uk-flex uk-flex-middle" uk-grid>
            ...
            <div class="uk-width-expand">
              <h6 class="uk-h6 uk-text-uppercase uk-text-bold uk-margin-remove"><?= lang('username') ?></h6>
              <p class="uk-text-meta uk-margin-remove"><?= user('username', $ban->value) ?></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <a href="<?= site_url('admin/bans') ?>" class="uk-button uk-button-primary"><?= lang('back') ?></a>
  </div>
</section>
