      ...
      <div class="uk-width-1-3@s uk-width-1-4@m">
        <div class="uk-card uk-card-default">
          <ul class="uk-nav-default" uk-nav>
            ...
            <li class="uk-active"><a href="<?= site_url('admin/bans/ips') ?>"><?= lang('banned_ips') ?></a></li>
          </ul>
        </div>
      </div>
        ...
        <div class="uk-card uk-card-default uk-margin">
          <div class="uk-card-header">
            <div class="uk-grid-small uk-margin-small uk-flex uk-flex-middle" uk-grid>
              <div class="uk-width-expand">
                <h3 class="uk-card-title"><?= lang('banned_ips') ?></h3>
              </div>
              <div class="uk-width-auto">
                <div class="uk-button-group">
                  <button href="#filter_toggle" class="uk-button uk-button-default uk-button-small uk-margin-small-right" type="button" uk-toggle="target: #filter_toggle; animation: uk-animation-slide-top-small"><i class="fa-solid fa-filter"></i></button>
                  <a href="<?= site_url('admin/bans/ips/add') ?>" class="uk-button uk-button-default uk-button-small"><i class="fa-solid fa-pen"></i> <?= lang('add') ?></a>
                </div>
              </div>
            </div>
          </div>
