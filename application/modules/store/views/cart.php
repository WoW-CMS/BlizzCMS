                    ...
                    <td>
                      <div class="uk-form-controls uk-light">
                        <select class="uk-select uk-width-1-1" onchange="updateCharacter(this, '<?php echo $item["rowid"]; ?>')">
                          ...
                          <?php foreach($this->wowrealm->getGeneralCharactersSpecifyAcc($this->wowrealm->getRealmConnectionData($this->store_model->getCategoryRealmId($item["category"])), $this->session->userdata('wow_sess_id')) as $listchar): ?>
