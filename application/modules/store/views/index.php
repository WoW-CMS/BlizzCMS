              ...
              <div>
                <div class="uk-card uk-card-default">
                  ...
                  <div class="uk-card-body uk-text-break">
                    ...
                    <?php endif; ?>
                    <a href="<?= site_url('store/item/'.$item->id); ?>" class="uk-button uk-button-default uk-button-small uk-width-1-1 uk-margin-small-top"><i class="fas fa-cart-plus"></i> <?= lang('cart'); ?></a>
                  </div>
                </div>
              </div>
              <?php endforeach; ?>
