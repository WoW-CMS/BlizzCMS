      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-top uk-margin-bottom" data-uk-grid>
          ...
          <div class="uk-width-auto">
            ...
            <a href="#" class="uk-button uk-button-default uk-button-small"><i class="far fa-edit"></i> <?= lang('edit_topic'); ?></a>
            <?php endif; ?>
          </div>
        </div>
      </div>
    ...
    <section class="uk-section uk-section-xsmall main-section" data-uk-height-viewport="expand: true">
      <div class="uk-container">
        ...
        <div class="uk-card uk-card-default">
          <div class="uk-card-header">
            <div class="uk-grid uk-grid-small" data-uk-grid>
              <div class="uk-width-expand">
                <h4 class="uk-h4 uk-text-bold"><span uk-icon="icon: comments; ratio: 1.2"></span> <?= html_escape($topic->title); ?></h4>
              </div>
        ...
        <div class="uk-grid uk-grid-small uk-child-width-1-1 uk-margin" data-uk-grid>
          ...
          <div>
            <div class="uk-card uk-card-default uk-card-body">
              <div class="uk-grid uk-grid-small" data-uk-grid>
                ...
                <div class="uk-width-expand@s">
                  <p class="uk-text-small uk-text-meta uk-margin-remove"><?= date('F d Y - H:i A', $post->created_at); ?></p>
                  <?= $post->commentary; ?>
                  <?php if ($this->auth->get_gmlevel() > 0 || $this->session->userdata('id') == $post->user_id && now() < strtotime('+30 minutes', $post->created_at)): ?>
                  <a href="<?= site_url('forum/post/delete/'.$post->id); ?>" class="uk-button uk-button-danger uk-button-small uk-margin-small-top uk-margin-remove-bottom"><i class="fas fa-trash-alt"></i> <?= lang('delete'); ?></a>
                  <?php endif; ?>
                </div>
              </div>
            </div>
          ...
          <div>
            <div class="uk-card uk-card-default uk-card-body">
              <h3 class="uk-h3 uk-text-center"><span uk-icon="icon: lock; ratio: 1.5"></span> <?= lang('not_authorized'); ?></h3>
          ...
          <div>
            <div class="uk-card uk-card-default uk-card-body">
              <h3 class="uk-h3 uk-text-center"><span uk-icon="icon: comment; ratio: 1.5"></span> <?= lang('join_conversation'); ?></h3>
              <div class="uk-grid uk-grid-small" data-uk-grid>
